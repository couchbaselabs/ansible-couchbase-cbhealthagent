...
| `cbhealthagent_user` | `couchbase` | Due to some of the checks that are performed, it is preferred to run as root. |
| `cbhealthagent_user_group` | `couchbase` | The name of the cbhealthagent user group on the OS. |
